...
jar_whitelist = [ # list of jars that will be scanned for messages.
    ...
    'snowflake-staging-vfs',
    'pentaho-ee-snowflake-plugin',
    ...
    # Adaptive-Execution directory
    'pdi-websocket-daemon',
    'pentaho-ee-streaming-amqp-plugin',
    'pdi-engine-api',
    'security',
    # Karaf
    'common-ui',
    'cpf-core',
    'data-refinery-pdi-plugin',
    'dataservice-geo-impl',
    'guava-cache-provider',
    'hadoop-cluster-ui',
    'metastore',
    'paz-plugin-ce',
    'pdi-dataservice-client-plugin',
    'pdi-dataservice-client-plugin-api',
    'pdi-dataservice-server-plugin',
    'pdi-osgi-bridge-activator',
    'pentaho-analyzer-xsd',
    'pentaho-authentication-mapper-api',
    'pentaho-authentication-mapper-impl',
    'pentaho-big-data-api-runtimeTest',
    'pentaho-big-data-impl-cluster',
    'pentaho-big-data-impl-clusterTests',
    'pentaho-big-data-impl-connections-s3',
    'pentaho-big-data-impl-vfs-hdfs',
    'pentaho-big-data-kettle-plugins-browse',
    'pentaho-big-data-kettle-plugins-common-job',
    'pentaho-big-data-kettle-plugins-common-ui',
    'pentaho-big-data-kettle-plugins-formats',
    'pentaho-big-data-kettle-plugins-formats-meta',
    'pentaho-big-data-kettle-plugins-guiTestActionHandlers',
    'pentaho-big-data-kettle-plugins-hbase',
    'pentaho-big-data-kettle-plugins-hbase-meta',
    'pentaho-big-data-kettle-plugins-hdfs',
    'pentaho-big-data-kettle-plugins-hive',
    'pentaho-big-data-kettle-plugins-kafka',
    'pentaho-big-data-kettle-plugins-mapreduce',
    'pentaho-big-data-kettle-plugins-oozie',
    'pentaho-big-data-kettle-plugins-pig',
    'pentaho-big-data-kettle-plugins-spark',
    'pentaho-big-data-kettle-plugins-sqoop',
    'pentaho-blueprint-activators',
    'pentaho-blueprint-collection-utils',
    'pentaho-bundle-resource-manager',
    'pentaho-cache-manager-api',
    'pentaho-camel-core',
    'pentaho-camel-snmp',
    'pentaho-connections',
    'pentaho-dataservice',
    'pentaho-dataservice-client',
    'pentaho-ehcache-provider',
    'pentaho-geo-agile-bi',
    'pentaho-i18n-bundle',
    'pentaho-i18n-webservice-bundle',
    'pentaho-kettle-repository-locator-api',
    'pentaho-kettle-repository-locator-impl-spoon',
    'pentaho-metastore-locator-api',
    'pentaho-metastore-locator-impl-local',
    'pentaho-metastore-locator-impl-repository',
    'pentaho-metaverse-core',
    'pentaho-metaverse-web',
    'pentaho-modeler',
    'pentaho-mongo-utils',
    'pentaho-mongodb-plugin',
    'pentaho-monitoring-plugin',
    'pentaho-object-tunnel',
    'pentaho-osgi-config',
    'pentaho-osgi-utils-impl',
    'pentaho-pdi-platform',
    'pentaho-pivot-table-viz-core',
    'pentaho-pivot-table-viz-impl',
    'pentaho-platform-plugin-deployer',
    'pentaho-spring-dm-extender',
    'pentaho-webjars-deployer',
    'pentaho-yarn-const',
    'pentaho-yarn-kettle-plugin'
]
